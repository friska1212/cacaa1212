...
**Data Analytics & Google Apps Script Enthusiast** — Saat ini sedang fokus membangun proyek otomatisasi perkantoran, sistem manajemen data, dan analisis bisnis menggunakan **Google Apps Script** dan **Microsoft Excel**.
...
**Fitur:**
- Form input jurnal (mata pelajaran, kelas, jam mengajar, materi)
- Riwayat jurnal dan fitur edit & hapus
